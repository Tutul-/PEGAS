...
IF SHIP:BODY:ATM:EXISTS {
    ...
    SET controls["upfgActivation"] TO 999.
}
...
SET ascentFlag TO -1.    // 0 = vertical, 1 = gravity assist, 2 = vacuum launch, 666 = abort, -1 = standby
...
UNTIL ABORT {
    ...
    ELSE IF ascentFlag = 1 {
        ...
        IF NOT maxQ AND previousQ > SHIP:DYNAMICPRESSURE {
            pushUIMessage("Max Q").
            SET maxQ TO TRUE.
        } ELSE IF maxQ AND previousQ < SHIP:DYNAMICPRESSURE {
            SET maxQ TO FALSE.
        }
